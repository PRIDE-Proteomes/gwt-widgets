...
public class ProxyServlet extends AbstractProxyServlet {
    ...
    /**
     * Uses the accessors retrieving of the Abstract Class and adding a handler to
     * the query string
     * @param httpServletRequest The {@link javax.servlet.http.HttpServletRequest} object passed
	 *                            in by the servlet engine representing the
	 *                            client request to be proxied
     * @return the proxy URL based on the received query
     */
    protected String getProxyURL(HttpServletRequest httpServletRequest) {
        String stringProxyURL = super.getProxyURL(httpServletRequest);
