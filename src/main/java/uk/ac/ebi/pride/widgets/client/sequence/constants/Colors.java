package uk.ac.ebi.pride.widgets.client.sequence.constants;

import com.google.gwt.canvas.dom.client.CssColor;

/**
 * @author ntoro
 * @since 18/09/15 17:27
 */
public class Colors {
    ...
    public static final CssColor AMINO_ACID_MODIFIED_SELECTED_COLOR = CssColor.make("rgba(255,255,0, 1)");
    public static final CssColor AMINO_ACID_MODIFIED_HIGHLIGHTED_COLOR = CssColor.make("rgba(255,255,255, 1)");
