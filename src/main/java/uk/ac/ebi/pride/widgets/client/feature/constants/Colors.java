package uk.ac.ebi.pride.widgets.client.feature.constants;
...
public class Colors {
    ...
    public static final CssColor FEATURE_BORDER_COLOR = CssColor.make("rgba(0,0,0, 1)");
    public static final CssColor FEATURE_BORDER_SELECTED_COLOR = CssColor.make("rgba(0,0,255, 1)");
    ...
    public static final CssColor FEATURE_REGION_BACKGROUND_COLOR = CssColor.make("rgba(255,255,255, 1)");
    public static final CssColor FEATURE_LINE_COLOR = CssColor.make("rgba(89,89,89, 1)");
